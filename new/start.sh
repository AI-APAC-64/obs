...
#   - otel_agent_v2/mcp/mcp_server.py add_sub   -> :8081 (prom :8001)
#   - otel_agent_v2/mcp/mcp_server.py mul_div   -> :8082 (prom :8002)
#   - uvicorn otel_agent_v2.agent.api:app         -> :8080 (prom :8000)
...
# (python-dotenv in api.py also loads it from CWD, but exporting here
...
python otel_agent_v2/mcp/mcp_server.py add_sub &
PIDS+=($!)
echo "[mcp] add_sub server -> localhost:8081 (metrics :8001)"

python otel_agent_v2/mcp/mcp_server.py mul_div &
PIDS+=($!)
...
uvicorn otel_agent_v2.agent.api:app --host 0.0.0.0 --port 8080 &
PIDS+=($!)
echo "[agent] otel_agent_v2.agent.api:app -> localhost:8080 (metrics :8000)"
