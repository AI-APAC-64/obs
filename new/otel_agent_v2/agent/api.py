...
Preconditions:
    - `python otel_agent_v2/mcp/mcp_server.py add_sub` running (port 8081)
    - `python otel_agent_v2/mcp/mcp_server.py mul_div` running (port 8082)
    - API_KEY env var set
"""
...
wd_otel.init("otel_agent_v2/agent/wd-otel-orchestrator.yaml")
...
from otel_agent_v2.agent.orchestrator import add_sub_server, mul_div_server, orchestrator
