...
```bash
pip install -e packages/wd-otel-core packages/wd-otel-mcp packages/wd-otel-orchestrator
...
**Terminal 3 — FastAPI:**
```bash
API_KEY=<your-key> uvicorn otel_agent_v2.agent.api:app --host 0.0.0.0 --port 8080
```
