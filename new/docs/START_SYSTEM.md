...
py -3.10 otel_agent_v2/mcp/mcp_server.py add_sub
```
...
cd c:\Obeserve
$env:API_KEY = "your-key-here"
py -3.10 otel_agent_v2/mcp/mcp_server.py mul_div
```
...
cd c:\Obeserve
$env:API_KEY = "your-key-here"
py -3.10 -m uvicorn otel_agent_v2.agent.api:app --host 0.0.0.0 --port 8080
```
